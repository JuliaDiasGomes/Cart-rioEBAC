...

{
	...
	printf("Digite o CPF a ser cadastrado: "); //coletando info do usuáirio
	scanf("%s", cpf); //%s refere-se a strings
	
	strcpy(arquivo, cpf); //responsável por copiar os valores das string
	
	FILE *file; //cria o arquivo no banco de dados
	file = fopen(arquivo,"w"); //cria o arquivo na pasta onde salvou o sistema e o "w" signifca escrever
